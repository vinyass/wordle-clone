...
function pressKey(key) {
    ...
    const nextTile = guessGrid.querySelector(':not([data-state])');
...
function submitGuess() {
    ...
    stopInteraction();
    activeTiles.forEach((...params) => flipTile(...params, guessedWord));
}

function flipTile(tile, index, array, guessedWord) {
    ...
    setTimeout(() => {
        ...
        tile.addEventListener('transitionend', () => {
            ...
            if(index === array.length - 1) {
                tile.addEventListener('transitionend', () => {
                    startInteraction();
                    checkWinLose(guessedWord, array)
                }, );
            }
        }, {once: true});
    }, 500 * index / 2)
...
function checkWinLose(guess, tiles) {
    if(guess === targetWord) {
        danceTiles(tiles);
        setTimeout(() => showAlert('You win', 5000), 1000)
    ...
    if(remainingTiles.length === 0) {
        showAlert('You lose: ' + targetWord, null);
    }
}
